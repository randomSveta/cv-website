...
export default function About(props) {
    const imgPath = require('../../../../../assets/images/HeroImage.jpg');
    return (
        <Row className="ml-5 mr-5 pl-5 pr-5 justify-content-center align-items-start">
            <Col className="m-4 p-4 about-text">
                <img src={imgPath} alt="..." className="rounded-circle about-img mx-auto d-block mb-4" />
                <p>
            ...
            <Col className="m-4 p-4 about-text " >
                <img src={imgPath} alt="..." className="rounded-circle about-img mx-auto d-block mb-4" />
                <p>  Luckily, having more than 5 years of experience as a QA Engineer I have quite a lot of experience with the software development life cycle, agile practices and working in a team.
                    ...
                    One the social side, I like travelling and socks with funny patterns.</p>
            </Col>
        </Row>
    );
}