...
export default function StatisticaCard(props) {
    ...
    return (
        <div className="mb-2 mb-md-0 mx-auto rounded-circle statistica-card text-white d-flex flex-column justify-content-center align-items-center flex-wrap app-dark-bg">
            <a id={tooltipId} href={props.stat.url} target="_blank" rel="noopener noreferrer" className="app-link app-link-underscore" aria-label={"Link to the " + props.stat.profile + " profile"}>
                <FontAwesomeIcon icon={props.stat.image} className="app-link-rotate-animation" aria-hidden="true" />
            </a>
