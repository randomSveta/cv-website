...
footer {
    background-color: aquamarine;
                    ...
                    The <strong>{`<html>`}</strong> element also has <em>width: 100%</em>, because it is by default, like the <strong>{`<body>`}</strong>, takes only height of all element inside but uses <em>background-color</em> to cover 100% of the page.
                                                                                            So I have added <em>height: 100%</em> property to make <em>background-color</em> be a real background and reflect the reality.
            ...
            <section>
                <Container>
                    ...
                    (<a href="https://www.w3schools.com/cssref/css_units.asp" alt="viewport height">100vh</a> - means 100% of the height of the viewport).
                </p>
                        </Col>
                    </Row>
                    <Row>
