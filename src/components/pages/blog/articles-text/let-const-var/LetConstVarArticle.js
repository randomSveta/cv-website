...
`}
                    ...
                    <Row className="my-3 justify-content-center">
                        <Col xs="12" md="8">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/undefined-outside-function-scope.png")} title="Value is not defined outside the function scope" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="12">
...
`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/var-block-scope.png")} title="Var keyword for the block scope" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="5">
...
`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/let-const-block-scope.png")} title="Let keyword for the block scope" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="5">
...
`}<span className="text-warning">console.log</span>{`("outside " + `}<span className="app-mint-text">x</span>{`);`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/let-const-block-scope.png")} title="Const keyword for the block scope" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="12">
...
`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/var-hoisting.png")} title="Var keyword hoisting" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="5">
...
`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/let-const-hoisting.png")} title="Let keyword hoisting" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="5">
...
`}
                        ...
                        <Col xs="12" md="7">
                            <ExpandImage src={require("../../../../../assets/images/blog/articles/let-const-var/let-const-hoisting.png")} title="Const keyword hoisting" class={" border"} />
                        </Col>
                    </Row>
                    <Row className="my-3">
                        <Col xs="12" md="7">
