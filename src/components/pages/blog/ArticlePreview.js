...
export default function ArticlePreview(props) {
  ...
  return (
    <Card className='rounded-0 article-preview-card'>
      <CardHeader className='font-weight-bold text-center rounded-0 art-card-bg'>
        <Link to={linkPath} className='app-link app-link-underscore text-decoration-none'>
          {props.article.title}
        </Link>
      </CardHeader>
      ...
      <CardFooter className='rounded-0 text-center art-card-bg'>
        <Link to={linkPath} className='app-link app-link-underscore text-decoration-none'>
          Full article &gt;&gt;
        </Link>
      </CardFooter>
