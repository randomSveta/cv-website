export const COURSES_PROJECTS = [
    ...
    },
    {
        ...
        description: 'Create webpages layout using Figma, PerfectPixel, Sass. Add animation and randomly created groups of images.',
        section: 'Courses'
    },
    {
        id: 2,
        ...
        description: 'Create a webpage layout using Figma, PerfectPixel, Sass. (Width of the body is fixed for 1600px, sorry :))',
        section: 'Courses'
    },
    {
        id: 3,
        ...
        description: 'Create a Momentum webpage using Youtube video as a first step and add new features (using Weather API, Quotes API, Browser Local Storage).',
        section: 'Courses'
    },
    {
        id: 4,
        ...
        description: 'Create a Calculator webpage using Youtube video as a first step and add new features like square actions with root, power, negative numbers, decimal numbers.',
        section: 'Courses'
    },

    {
        ...
        description: 'First task for The Rolling Scopes School - https://rs.school/. which represents a simple one page CV.',
        section: 'Courses'
    },
